...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($res && $res->num_rows === 1) {
        ...
        $conn->query("UPDATE customers SET password='$hash' WHERE id={$user['id']}");
        ...
        <div style='font-family:sans-serif;max-width:500px;margin:auto;padding:30px;border:1px solid #eee;border-radius:10px;'>
          <h2 style='color:#FF6B35;'>AutoCare – Your Password</h2>
          ...
          <a href='" . SITE_URL . "/customer/login.php' style='display:inline-block;background:#FF6B35;color:white;padding:10px 24px;border-radius:6px;text-decoration:none;'>Go to Login</a>
        </div>";
        ...
        $message = "No account found with that email."; $type = 'error';
    }
}
?>
<!DOCTYPE html>
